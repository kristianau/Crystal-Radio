...
AM radio ranges from about 500 kHz to 1700 kHz frequency.

Measured capacitor value interval: $[0.3, 1.48]$ nF.

Made a simple circuit today. Looks like the bandwidth is the one that is changing. Also. How can a parallel CL circuit work like a band pass filter if input and output are measured from same ports???
...
\begin{figure}
\centering
\includegraphics[width=0.25\linewidth]{bilder/bandPassFilter.pdf}
